...
{
    std::cout << "      |---- test_heat_conduction_equation_2D_2()" << std::endl;
    ...
    constexpr int grid_steps_amount_x = 120;
    ...
    constexpr Boundary_conditions lbc_x = Boundary_conditions::Neumann;
    constexpr Boundary_conditions rbc_x = Boundary_conditions::Neumann;
    constexpr Boundary_conditions lbc_y = Boundary_conditions::Neumann;
    constexpr Boundary_conditions rbc_y = Boundary_conditions::Neumann;
        ...
        noexcept -> double
    {
        ...
        return std::cos(M_PI * eigenvalue_factor * x / coordinate_length_x);
    };
        ...
        noexcept -> double
    {
        ...
        return std::cos(M_PI * eigenvalue_factor * y / coordinate_length_y);
    };
