...
void test_wave_equation_1D_5() noexcept
{
    std::cout << "      |---- test_wave_equation_1D_5()" << std::endl;
    ...
    Wave_equation_1d<lbc, rbc>
        wave_equation{
            init_conditions,
            std::make_pair(function_lbc_m, function_lbc_c),
            std::make_pair(function_rbc_m, function_rbc_c),
            source,
            grid_steps_amount,
            lbc_coordinate,
            rbc_coordinate,
