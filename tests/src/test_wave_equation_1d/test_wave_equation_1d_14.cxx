...
void test_wave_equation_1D_14() noexcept
{
    std::cout << "      |---- test_wave_equation_1D_14()" << std::endl;
    ...
    constexpr Boundary_conditions lbc = Boundary_conditions::Robin;
        ...
        noexcept -> Grid_variable
    {
        ...
        res[grid_variable_displacement_number] += 10.0 * x - 5.0;
        res[grid_variable_velocity_number] += 0.0;
    ...
    Wave_equation_1d<lbc, rbc>
        wave_equation{
            init_conditions,
            std::make_pair(function_lbc_c, function_lbc_m),
            function_rbc,
            source,
            grid_steps_amount,
            lbc_coordinate,
